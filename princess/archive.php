			...
			//has sidebar	
				...
				//add full width title 	
					...
					<div class="tp-title style2 page-title">
						<div class="titles">';
						if ( is_day() ){
							print '<h1>'.__('DAILY ARCHIVES','princess').'</h1><br /><h5>'.get_the_date().'</h5>';
						}elseif ( is_month() ){
							print '<h1>'.__('MONTHLY ARCHIVES','princess').'</h1><br /><h5>'.strtoupper(get_the_date( _x( 'F Y', 'monthly archives date format', 'princess' ) )).'</h5>';
						}elseif ( is_year() ){
							print '<h1>'.__('YEARLY ARCHIVES','princess').'</h1><br /><h5>'.get_the_date( _x( 'Y', 'yearly archives date format', 'princess' ) ).'</h5>';
						}else{
							print '<h1>'.__('ARCHIVES','princess').'</h1>';
						}
						print '
						</div>
					</div>
